                ...
                >
                    ...
                    <div className="px-6 sm:px-8 pb-6 sm:pb-8">
                        <button
                            ...
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 font-bold rounded-xl transition-all shadow-sm mb-5 disabled:opacity-50"
                        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-3 px-4 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-xl shadow-sm shadow-teal-500/20 transition-all flex justify-center items-center mt-2 h-12 disabled:opacity-60"
                            >
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm font-medium text-slate-500">
                                ...
                                <Link href="/login" className="text-teal-600 hover:text-teal-700 font-bold transition-colors">Sign in</Link>
                            </p>
                        </div>
                    </div>
                </motion.div>
