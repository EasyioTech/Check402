        ...
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-teal-100 selection:text-teal-900 overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
                    <div className="max-w-2xl text-center lg:text-left">
                        ...
                        >
                            check402 lets you control access to client web applications based on payment status. Drop in a single script tag and automate enforcement effortlessly.
                        </motion.p>
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-2 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm hover:border-slate-300 transition-colors">
                            ...
                            <p className="text-slate-600 max-w-md leading-relaxed">If check402 is unreachable or blocked by ad-blockers, client apps simply continue working. Zero risk to production reliability.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className="space-y-8 sm:space-y-12">
                            <div className="flex gap-4 sm:gap-6 text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base text-slate-500 font-medium leading-relaxed">Add the client to your check402 dashboard. We instantly generate a unique, secure API edge key.</p>
                                </div>
                            </div>
                            <div className="flex gap-4 sm:gap-6 text-left">
                    ...
                    <div className="grid md:grid-cols-2 max-w-4xl mx-auto gap-8 items-start">
                        ...
                        <div className="bg-white rounded-3xl p-8 border-2 border-teal-500 shadow-xl shadow-teal-500/10 relative mt-8 md:mt-0">
                            ...
                            <ul className="space-y-4 mb-8">
                                ...
                                <li className="flex items-center gap-3 text-slate-600 text-sm font-medium"><CheckCircle2 className="w-5 h-5 text-teal-500" /> Remove check402 branding (Soon)</li>
            ...
            <section className="py-24 bg-white border-t border-slate-100">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="text-base sm:text-lg text-slate-600 mb-8 max-w-2xl mx-auto">Join developers worldwide using check402 to ensure they get paid for their hard work.</p>
            ...
            <footer className="bg-white border-t border-slate-100 py-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6">
                    ...
                    <p className="text-sm text-slate-400">© {new Date().getFullYear()} check402. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
